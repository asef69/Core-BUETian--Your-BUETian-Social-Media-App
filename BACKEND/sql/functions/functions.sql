--mutual followers 
DROP FUNCTION IF EXISTS get_mutual_followers(INTEGER);
...
--SEARCH USER
--POST SEARCH
DROP FUNCTION IF EXISTS search_posts(VARCHAR, INTEGER);
...
--MARK AS READ
--CHAT RELATED WORKS
DROP FUNCTION IF EXISTS get_recent_conversations(INTEGER);
...
--USER SUMMARY WORKS
DROP FUNCTION IF EXISTS get_user_activity_summary(INTEGER);
...
DROP FUNCTION IF EXISTS get_suggested_users(INTEGER, INTEGER);
...
DROP FUNCTION IF EXISTS get_pending_follow_requests(INTEGER);
...
DROP FUNCTION IF EXISTS search_users_advanced(VARCHAR, VARCHAR, INTEGER, VARCHAR, INTEGER);
...
DROP FUNCTION IF EXISTS get_users_by_department(VARCHAR, INTEGER, INTEGER);
...
DROP FUNCTION IF EXISTS get_users_by_blood_group(VARCHAR, INTEGER);
...
DROP FUNCTION IF EXISTS get_notification_summary(INTEGER);
...
DROP FUNCTION IF EXISTS mark_notifications_read_by_type(INTEGER, VARCHAR);
...
DROP FUNCTION IF EXISTS get_activity_notifications(INTEGER, INTEGER);
...
DROP FUNCTION IF EXISTS get_unread_messages_count(INTEGER);
...
DROP FUNCTION IF EXISTS get_total_unread_messages(INTEGER);
...
DROP FUNCTION IF EXISTS search_messages(INTEGER, VARCHAR, INTEGER);
...
DROP FUNCTION IF EXISTS delete_conversation(INTEGER, INTEGER);
...
DROP FUNCTION IF EXISTS mark_conversation_read(INTEGER, INTEGER);
...
DROP FUNCTION IF EXISTS get_user_message_stats(INTEGER);
...
DROP FUNCTION IF EXISTS get_conversation_participants(INTEGER, INTEGER);
...
DROP FUNCTION IF EXISTS reject_follow_request(INTEGER, INTEGER);
