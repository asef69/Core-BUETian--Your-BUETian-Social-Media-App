...
export const marketplaceAPI = {
  ...
  markSold: (productId, data = {}) => api.post(`/marketplace/products/${productId}/mark-sold/`, data),
  reserveProduct: (productId, data = {}) => api.post(`/marketplace/products/${productId}/reserve/`, data),
